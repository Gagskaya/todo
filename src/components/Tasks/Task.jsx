...
export const Task = ({ id, text, removeTask, completed,editTask,checkboxChange }) => {
    return (
        <div className="tasks__items-row" key={id} >
            <div className="checkbox" >
                <input type="checkbox" id={`task-${id}`} onChange={(e) => checkboxChange(id,e.target.checked,completed)} checked={completed}/>
            ...
            <p>{text}</p>
            <i className="tasks__items-row-edit" onClick={() => editTask(id,text)}>
            ...
            <i className="tasks__items-row-remove" onClick={() => removeTask(id)}>
